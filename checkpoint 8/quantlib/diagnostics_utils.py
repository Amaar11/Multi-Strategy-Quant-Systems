...
def save_backtests(portfolio_df, isntruments, brokerage_used, sysname, path="./backtests"):
    ...
    ax.annotate(
        annotation, xy=(0.2, 0.8), xycords="axes fraction", bbox=dict(boxstyle="round, pad=0.5", fc="white", alpha= 0.3,), ha="center", va="center", family="sefif", size="8"
    )
